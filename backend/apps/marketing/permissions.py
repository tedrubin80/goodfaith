...
class CanAccessMarketing(BasePermission):
    """
    Marketing campaigns: Manager/A&R run promos; Artists see own campaigns;
    Finance read-only for spend awareness (no write).
    """
