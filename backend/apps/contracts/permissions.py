...
class CanAccessContracts(BasePermission):
    """
    Contracts are visible to label ops and linked artists (Gap 5).
    A&R manages deals; Finance reads for compliance; Artists see own deals only.
    """
